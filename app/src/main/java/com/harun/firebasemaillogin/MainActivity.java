package com.harun.firebasemaillogin;
                    ...
                    if(task.getResult() != null && task.getResult().getSignInMethods() != null){
                        ...
                        if(girisYap){ // Giriş işlemleri için
                            ...
                            if(email_var){
                                ...
                                Toast.makeText(MainActivity.this,"Mail Adresi Bulunamadi!",Toast.LENGTH_SHORT).show();
                            ...
                            if(email_var){
                                ...
                                Toast.makeText(MainActivity.this,"Bu Maile Kayıtlı Bir Üyelik Zaten Bulunmakta!",Toast.LENGTH_LONG).show();
        ...
        mAuth.createUserWithEmailAndPassword(mail, sifre).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful() && task.getResult() != null){
                    ...
                    Toast.makeText(MainActivity.this,"Üyelik Başarılı! Aktivasyon Linki Mailinize Gönderildi!",Toast.LENGTH_LONG).show();
